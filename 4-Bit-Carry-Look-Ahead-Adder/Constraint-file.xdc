...
## LEDs for cout and sum
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { cout }];   
set_property -dict { PACKAGE_PIN K15 IOSTANDARD LVCMOS33 } [get_ports { sum[0] }];
set_property -dict { PACKAGE_PIN J13 IOSTANDARD LVCMOS33 } [get_ports { sum[1] }];  
set_property -dict { PACKAGE_PIN N14 IOSTANDARD LVCMOS33 } [get_ports { sum[2] }];  
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 } [get_ports { sum[3] }];  

## Buttons for clk and reset
